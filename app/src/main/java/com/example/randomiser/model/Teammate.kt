    ...
    companion object {
        fun makeList() =
            mutableListOf(
                ...
                Teammate("Ethan Berg", Color(0xFFF8D629), Platform.Android),
                Teammate("Chao Peng", Color(0xFF2F4FFF), Platform.iOS),
                Teammate("Andrew Hughes", Color(0xFF2FEE0D), Platform.Android),
                Teammate("Matt Smith", Color(0xFF000000), Platform.iOS),
